...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude
                  → checks /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done
                  → writes to /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/hooks/
...
@/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
