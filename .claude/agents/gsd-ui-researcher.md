...
Use template from `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
