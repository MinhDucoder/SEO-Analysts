...
Reference full template: `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/state.md`.
