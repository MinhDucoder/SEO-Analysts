...
<execution_context>
@/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/workflows/docs-update.md end-to-end.
