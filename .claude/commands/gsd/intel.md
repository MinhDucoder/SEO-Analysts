...
Intel system is disabled. To activate:
  ...
  node /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/bin/gsd-tools.cjs
