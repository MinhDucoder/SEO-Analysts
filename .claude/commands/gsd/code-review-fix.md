...
<execution_context>
@/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
