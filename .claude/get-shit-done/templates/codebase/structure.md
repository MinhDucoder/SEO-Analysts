...
- Usage: Reference from command with `@/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
