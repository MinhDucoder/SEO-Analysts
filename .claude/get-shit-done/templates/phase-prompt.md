...
<!-- For checkpoint task examples and patterns, see @/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/references/checkpoints.md -->
...
See `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
