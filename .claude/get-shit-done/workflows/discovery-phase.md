...
See /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/discovery.md
...
Use /media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/get-shit-done/templates/discovery.md.
