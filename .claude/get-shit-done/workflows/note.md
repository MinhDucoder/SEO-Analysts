...
- **Global scope**: `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/notes/`)
...
2. Glob `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/media/minhducoder/New Volume2/Learn_On_Drive/DO_AN/.claude/notes/` — works in any directory
