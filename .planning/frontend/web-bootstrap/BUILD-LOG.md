...
| 6 (PLAN W7) | App shell: providers, error, layout | 3 (src/app/providers.tsx with QueryClient 60s staleTime + Toaster; src/app/error.tsx global error boundary with Card + reset; src/app/layout.tsx next/font Manrope+Inter + html lang="vi" + metadata/viewport + Providers wrap) | (this commit) | ✅ done |
