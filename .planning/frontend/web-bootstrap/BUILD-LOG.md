...
| 7 (PLAN W8) | Placeholder page `app/page.tsx` | 1 (RSC landing renders Badge "web-bootstrap" + Manrope wordmark display-lg + tagline + status text + primary Button — smoke-tests token wiring end-to-end) | (this commit) | ✅ done |
